...
def main():
    parser = argparse.ArgumentParser(
        description="Run the SoftwareX replication_old example end-to-end."
    )
    parser.add_argument(
        "--config",
        type=str,
        default="config/configuration.ini",
        help="Path to the example configuration file (relative to replication_old/).",
    )
    parser.add_argument(
        "--project-root",
        type=str,
    ...
    print("Check outputs/logs as specified in config (ideally under replication_old/output/).")
